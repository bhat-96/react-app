                            ...
                            <div className={classes.formWrapper}>
                                <Formik
                                    ...
                                    initialValues={{
                                        ...
                                        PatientMiddleName: selectedRow.PatientMiddleName || '',
                                        PatientLastName: selectedRow.PatientLastName || '',
                                        FatherHusbandName: selectedRow.FatherHusbandName || '',
                                        Height: selectedRow.Height || '',
                                        Weight: selectedRow.Weight || '',
                                        PermanentAddress1: selectedRow.PermanentAddress1 || '',
                                        PermanentPinCode: selectedRow.PermanentPinCode || '',
                                        MobileNumber: selectedRow.MobileNumber || '',
                                        EmailId: selectedRow.EmailId || '',
                                        Occupation: selectedRow.Occupation || '',
                                        ReligionId: selectedRow.ReligionId || '',
                                        country: selectedRow.PermanentCountryId || '',
                                        state: selectedRow.PermanentStateId || '',
                                        city: selectedRow.PermanentPlaceId || '',
                                        dob: selectedRow.DateOfBirth ? formatDateToYYYYMMDD(selectedRow.DateOfBirth) : '',
                                        title: selectedRow.PatientTitle || '',
                                        PatientGender: selectedRow.Gender || '',
                                        MaritalStatus: selectedRow.MaritalStatus || '',
                                        PermanentStateId: selectedRow.PermanentStateId || '',
                                        PermanentPlaceId: selectedRow.PermanentPlaceId || '',
                                        PermanentAreaId: selectedRow.PermanentAreaId || '',
                                    }}
